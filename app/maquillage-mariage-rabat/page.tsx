...
const PAGE_URL = `${SITE_URL}/maquillage-mariage-rabat`;

export const metadata: Metadata = {
  title: "Makeup Artist Rabat — Maquillage Mariée",
  description:
    "Tyma, makeup artist professionnelle, se déplace à Rabat pour votre mariage. Essai inclus, keswa et takchita, 10+ ans d'expérience, 500+ mariées, note 4,8/5 sur Google.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    type: "website",
    url: PAGE_URL,
    title: "Makeup Artist Rabat — Maquillage Mariée | Tyma",
    description: "Makeup artist professionnelle disponible à Rabat pour votre mariage. Essai inclus, longue tenue garantie.",
    images: [{ url: "/og-image.jpg", width: 1200, height: 630, alt: "Tyma — Makeup Artist Rabat" }],
  },
};
...
const jsonLd = {
  ...
  "@type": "Service",
  "name": "Maquillage Mariée à Rabat",
...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Maquillage Mariage Rabat", "item": PAGE_URL },
  ],
};
      ...
      <main>
        <section className="pt-40 pb-20" style={{ background: "var(--s0)" }}>
          <div className="max-w-4xl mx-auto px-5">
            <p className="type-label mb-4" style={{ color: "var(--gold)" }}>Rabat</p>
            <h1 className="type-section mb-6" style={{ color: "var(--t0)" }}>
              Makeup Artist à Rabat<br />
            ...
            <p className="text-base leading-relaxed max-w-2xl mb-8" style={{ color: "var(--t1)" }}>
              Basée à Casablanca, Tyma se déplace régulièrement à Rabat pour le maquillage de mariée.
              Plus de 10 ans d&apos;expérience, plus de 500 mariées sublimées, note 4,8/5 sur Google (41 avis).
              Essai inclus, maquillage longue tenue conçu pour résister 12 à 16h, parfait pour les longues
              journées de mariage traditionnel.
            </p>
        ...
        <section className="py-20" style={{ background: "var(--s1)" }}>
          <div className="max-w-4xl mx-auto px-5">
            <h2 className="type-section mb-8" style={{ color: "var(--t0)", fontSize: "clamp(2rem, 3.5vw, 3rem)" }}>
              Pourquoi choisir Tyma à Rabat
            </h2>
            <div className="grid sm:grid-cols-2 gap-5">
              {[
                { title: "Déplacement à Rabat et environs", text: "Studio à domicile ou sur le lieu de l'événement, à Rabat, Salé et Témara. Frais de déplacement selon la distance." },
                ...
                { title: "Essai avant le jour J", text: "Séance d'essai (~2h) pour ajuster le look sous différentes lumières avant le grand jour." },
              ].map((f) => (
